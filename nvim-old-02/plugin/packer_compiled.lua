...
_G.packer_plugins = {
  ...
  ["auto-session"] = {
    config = { "\27LJ\2\n’\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\2B\0\2\1K\0\1\0\18pre_save_cmds\1\4\0\0\16CtrlSFClose\18NvimTreeClose\17TroubleClose\1\0\1\14log_level\nerror\nsetup\17auto-session\frequire\0" },
    loaded = true,
  ...
  ["ctrlsf.vim"] = {
    after_files = { "/Users/albertos/.local/share/nvim/site/pack/packer/opt/ctrlsf.vim/after/plugin/ctrlsf.vim" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/Users/albertos/.local/share/nvim/site/pack/packer/opt/ctrlsf.vim",
  ...
  ["leap.nvim"] = {
    config = { "\27LJ\2\n,\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\17plugins.leap\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
try_loadstring("\27LJ\2\n2\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\23plugins.statusline\frequire\0", "config", "lualine.nvim")
...
vim.cmd [[au User DeferLoad5 ++once lua require("packer.load")({'ctrlsf.vim'}, { event = "User DeferLoad5" }, _G.packer_plugins)]]
vim.cmd [[au User DeferLoad4 ++once lua require("packer.load")({'leap.nvim', 'Comment.nvim', 'nvim-autopairs', 'nvim-surround', 'better-escape.nvim', 'vim-matchup'}, { event = "User DeferLoad4" }, _G.packer_plugins)]]
vim.cmd [[au User DeferLoad3 ++once lua require("packer.load")({'nvim-cmp', 'nvim-tree.lua'}, { event = "User DeferLoad3" }, _G.packer_plugins)]]
vim.cmd [[au User DeferLoad2 ++once lua require("packer.load")({'nvim-colorizer.lua', 'vim-fugitive', 'trouble.nvim'}, { event = "User DeferLoad2" }, _G.packer_plugins)]]
vim.cmd [[au User PackerComplete ++once lua require("packer.load")({'nvim-colorizer.lua', 'leap.nvim', 'vim-fugitive', 'telescope.nvim', 'nvim-cmp', 'Comment.nvim', 'ctrlsf.vim', 'nvim-tree.lua', 'trouble.nvim', 'nvim-autopairs', 'nvim-surround', 'better-escape.nvim', 'vim-matchup'}, { event = "User PackerComplete" }, _G.packer_plugins)]]
vim.cmd [[au User DeferLoad1 ++once lua require("packer.load")({'telescope.nvim'}, { event = "User DeferLoad1" }, _G.packer_plugins)]]
